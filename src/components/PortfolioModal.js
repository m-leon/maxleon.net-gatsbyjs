...
export default (props) => (
  ...
  >
    ...
    <img src={props.image} className="portfolio__modal__image" alt={props.title} />
    { props.content && <p>{props.content}</p> }
    <div className="portfolio__modal__links">
      { props.github && <a href={props.github}><Icon size={32} icon={github} /></a> }
      { props.link && <a href={props.link}><Icon size={32} icon={link} /></a> }
    </div>
  </ReactModal>
);
