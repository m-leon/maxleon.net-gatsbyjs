...
import ABTestIcon from './ab-testing.svg';
import CodingIcon from './coding.svg';
import styles from './styles';
import Typography from '../modules/Typography';
import WireframeIcon from './wireframe.svg';
      ...
      <Container className={classes.container}>
        ...
        <div>
          <Grid container spacing={5}>
            ...
            <Grid item xs={12} md={4}>
              <div className={classes.item}>
                <img src={CodingIcon} alt="Coding" className={classes.image} />
            ...
            <Grid item xs={12} md={4}>
              <div className={classes.item}>
                <img src={ABTestIcon} alt="AB Test" className={classes.image} />
                <Typography variant="h6" align="center">
